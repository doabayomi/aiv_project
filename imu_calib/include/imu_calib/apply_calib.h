#ifndef IMU_CALIB_APPLY_CALIB_HPP
#define IMU_CALIB_APPLY_CALIB_HPP
...
private:
  ...
  void rawImuCallback(const sensor_msgs::msg::Imu::SharedPtr raw);
...
#endif // IMU_CALIB_APPLY_CALIB_HPP
